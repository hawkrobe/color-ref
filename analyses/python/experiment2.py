...
# because we only had 199 unique words, append another word to the end of the
# context with 3 words from the last 20 words according to entropy
# make sure that the word that is appended was not also used twice in the
#previous set of 50 contexts (aka the very last word of that set)
