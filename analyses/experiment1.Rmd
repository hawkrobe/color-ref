...
Check how many people failed out early (e.g. on catch trials)
...
```{r}
dIntraparticipant = read_csv('./intra-participant/block1-block2-deltaE.csv') 
```
