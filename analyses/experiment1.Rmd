...
cor.test(log(tmp$empirical_stat_groundTruth), tmp$empirical_stat_sliderResponse)
cor.test(tmp$empirical_stat_groundTruth, tmp$empirical_stat_sliderResponse)
